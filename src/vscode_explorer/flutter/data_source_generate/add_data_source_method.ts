...
class DataPathResolver {
    ...
    constructor(dataFolderPath: string) {
        ...
        this.domainRepoPath = path.join(domainDir, 'repo', `${this.featureNameSnakeCase}_repository.dart`);
        this.remoteDatasourcePath = path.join(dataDir, 'datasources', `${this.featureNameSnakeCase}_remote_datasource.dart`);
        this.remoteDatasourceImplPath = path.join(dataDir, 'datasources', `${this.featureNameSnakeCase}_remote_datasource_impl.dart`);
